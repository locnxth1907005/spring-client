 ...
 * 
 */
@WebServiceClient(name = "StudentServiceService", targetNamespace = "http://service.demospringservice.example.com/", wsdlLocation = "http://localhost:8088/ws/student?wsdl")
    ...
    extends Service
{
    ...
    private final static QName STUDENTSERVICESERVICE_QNAME = new QName("http://service.demospringservice.example.com/", "StudentServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8088/ws/student?wsdl");
    ...
    public StudentService getStudentServicePort() {
        return super.getPort(new QName("http://service.demospringservice.example.com/", "StudentServicePort"), StudentService.class);
    }
    ...
    public StudentService getStudentServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.demospringservice.example.com/", "StudentServicePort"), StudentService.class, features);
    }
